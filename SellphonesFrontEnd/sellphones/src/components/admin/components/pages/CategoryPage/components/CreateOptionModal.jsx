...
export default function CreateCategoryOptionModal({ isOpen, onClose, onCreate }) {
    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <h2 className="text-xl font-semibold mb-6 text-white">Tạo option mới</h2>
