...
export default function EditFilterOptionModal({ isOpen, onClose, onUpdate, onDelete, option }) {
        ...
        <AnimatePresence>
            {isOpen && (
                <>
                    ...
                    >
                        <h2 className="text-xl font-semibold text-white mb-6">Chỉnh sửa Filter Option</h2>
                        ...
                        <div className="space-y-4">
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="w-full px-4 py-2 mt-6 bg-green-600 text-white rounded hover:bg-green-700 disabled:opacity-50"
                            >
