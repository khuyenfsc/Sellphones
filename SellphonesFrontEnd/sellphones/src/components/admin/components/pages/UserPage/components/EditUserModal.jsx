                ...
                <>
                    ...
                    >
                        ...
                        <div className="space-y-4">
                            ...
                            <button
                                className="w-full py-2 bg-blue-700 text-white rounded hover:bg-blue-800 transition mt-4"
                                onClick={() => {
                            ...
                            >
                                {changePassword ? "Hủy thay đổi mật khẩu" : "Thay đổi mật khẩu"}
                            </button>

                            {/* New password */}
                            {changePassword && (
                                <div>
                                    <label className="text-gray-300 block mb-1 mt-2">Mật khẩu mới</label>
                                    <input
                                        type="password"
                                        value={password}
