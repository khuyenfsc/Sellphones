// CreateWarrantyModal.jsx
import { motion, AnimatePresence } from "framer-motion";
import { useState } from "react";

export default function CreateWarrantyModal({ isOpen, onClose, onCreate }) {
    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <h2 className="text-xl font-semibold mb-6 text-white">Tạo bảo hành mới</h2>
