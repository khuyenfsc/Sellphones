...
export default function AccountInfo() {
    ...
    useEffect(() => {
        async function fetchCustomerInfos() {
            ...
            if (res.success) setCustomerInfos(res.data);
            setLoading(false);
        }
        fetchCustomerInfos();
    }, []);
    ...
    return (
        <div className="min-h-screen bg-gray-50 p-6">
            <div className="max-w-5xl mx-auto space-y-6">
                ...
                {/* Địa chỉ */}
                <CustomerAddressList loading={loading} customerInfos={customerInfos} setCustomerInfos={setCustomerInfos} />
                ...
                <div className="grid grid-cols-2 gap-6">
                    ...
                    <div className="bg-white rounded-lg shadow-sm p-6">
                        <h2 className="text-xl font-semibold mb-6">Tài khoản liên kết</h2>
