...
import SelectableCustomerAddressList from "./SelectableCustomerAddressList";
...
export default function CheckoutPage() {
    ...
    const handleCreateOrder = async () => {
        if (!selectedCustomer || selectedItems.length === 0 || creatingOrder) return;
        ...
        try {
            ...
            if (result.success) {
                ...
                setTimeout(() => {
                    navigate("/"); // quay về trang chủ sau 1s để toast hiển thị
                }, 1000);
            } else {
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="bg-white shadow-sm sticky top-0 z-10">
                <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between relative">
                    ...
                    {/* giữ khoảng trống để căn giữa tiêu đề */}
            ...
            <div className="max-w-6xl mx-auto px-4 py-6 flex flex-col lg:flex-row gap-6">
                    ...
                    <div className="bg-white rounded-lg shadow p-4 text-black">
                        ...
                        <div className="flex flex-col gap-3">
                            <label className="flex items-center gap-2 cursor-pointer">
                                <input type="radio" name="payment" value="cod" className="accent-red-600" />
                                Thanh toán khi nhận hàng (COD)
                            </label>
                            <label className="flex items-center gap-2 cursor-pointer">
                                <input type="radio" name="payment" value="online" className="accent-red-600" />
                ...
                {/* Right: danh sách sản phẩm đã chọn */}
                <div className="w-full lg:w-1/2 flex flex-col space-y-4">
                    ...
                    <button
                        ...
                        disabled={!selectedCustomer || selectedItems.length === 0 || creatingOrder}
                        className={`mt-4 w-full py-4 rounded-lg font-semibold text-lg transition ${selectedCustomer && selectedItems.length > 0
